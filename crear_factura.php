...
?>
<title>AGEXPORT - Asociación de Exportadores de Guatemala</title>
			...
			<input id="currency" type="hidden" value="$">
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-right">
					...
					<div class="form-group">
						<input type="text" class="form-control" name="companyName" id="companyName" placeholder="Nombre del Cliente" autocomplete="off">
					</div>
					<div class="form-group">
					...
					<span class="form-inline">
						<div class="form-group">
							...
							<div class="input-group">
								<div class="input-group-addon currency">Q</div>
