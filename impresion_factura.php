...
$output .= '<table width="100%" border="1" cellpadding="5" cellspacing="0">
	<tr>
	<td colspan="2" align="center" style="font-size:18px"><b>AGEXPORT</b></td>
	</tr>
	<tr>
	<td colspan="2">
...
$output .= '
	...
	<tr>
	<td align="right" colspan="5"><b> Porcentaje de Impuesto :</b></td>
	<td align="left">' . $invoiceValues['order_tax_per'] . ' %</td>
	</tr>
	<tr>
	<td align="right" colspan="5"><b>Impuestos:</b></td>
	<td align="left">' . $invoiceValues['order_total_tax'] . '</td>
	</tr>
	<tr>
	<td align="right" colspan="5"><b>Monto Pagado:</b></td>
...
$invoiceFileName = 'FACTURA-' . $invoiceValues['order_id'] . '.pdf';
